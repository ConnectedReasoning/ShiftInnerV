...
def make_crew(ticker1: str, ticker2: str) -> tuple:
    """
    Instantiate a fresh set of agents with the correlation tool locked
    to the given pair. Call this once per pair instead of reusing the
    module-level agents.

    Returns (quant_scout, forensic_researcher, skeptic_analyst).
    """
    # Tool locked to this pair — rejects any other ticker arguments
    ...
    return quant_scout, forensic_researcher, skeptic_analyst
