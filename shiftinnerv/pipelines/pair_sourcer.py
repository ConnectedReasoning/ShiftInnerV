...
MIN_CORRELATION = 0.4        # Only pair tickers with >0.3 rolling correlation
CORRELATION_WINDOW = 50     # 1 year rolling window for correlation
DECAY_WINDOW = 25           # 6 months — detect recent correlation weakening
